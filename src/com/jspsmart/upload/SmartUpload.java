...
/*      */ 
/*  265 */       i1 = (str1.indexOf("filename") > 0) ? 1 : 0;
/*      */ 
...
/*      */     try
/*      */     {
/*  434 */       i = this.m_binArray[paramInt];
/*      */     } catch (Exception localException) {
...
/*  701 */       k = j;
/*  702 */       str1 = "\"";
/*  703 */       l = paramString1.indexOf(str1, j);
/*  704 */       if ((k > 0) && (l > 0)) str2 = paramString1.substring(k, l);
/*      */     }
/*  706 */     return str2;
/*      */   }
/*      */ 
...
/*  818 */     int k = 0;
/*  819 */     int l = this.m_boundary.length();
...
/*      */     }
/*      */ 
/*  840 */     this.m_currentIndex = (this.m_endData + l + 3);
/*      */   }
/*      */ 
...
/*      */       }
/*      */     }
/*  866 */     String str = new String(this.m_binArray, i, j - i + 1);
/*  867 */     return str;
/*      */   }
/*      */ 
...
/*      */         }
/*      */       }
/*  923 */       if (str == "") return; this.m_deniedFilesList.addElement(str); } else {
/*  924 */       this.m_deniedFilesList = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */         }
/*      */       }
/*  955 */       if (str == "") return; this.m_allowedFilesList.addElement(str); } else {
/*  956 */       this.m_allowedFilesList = null;
/*      */     }
/*      */   }
/*      */ 
